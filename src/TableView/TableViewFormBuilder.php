...
class TableViewFormBuilder
{
     ...
     * @var string
     */
    protected $plainFormClass = TableViewForm::class;
     ...
     */
    public function __construct(Container $container, DataViewFormHelper $formHelper, EventDispatcher $eventDispatcher)
    {
     ...
     *
     * @param string $formClass The name of the class that inherits TableViewForm.
