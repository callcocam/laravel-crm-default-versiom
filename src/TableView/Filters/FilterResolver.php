...
use SIGA\TableView\Filters\Exception\InvalidInstanceException;
use SIGA\TableView\Filters\Exception\UnableToResolveFilterException;
...
class FilterResolver
{
    ...
    {
        return "\\SIGA\\TableView\\Filters\\Collection\\";
    }
}