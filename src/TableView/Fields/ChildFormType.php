...
class ChildFormType extends ParentType
{
     ...
     *
     * @param  TableViewForm  $mainForm
     * @param  bool  $isValid
     * @return void
     */
    public function alterValid(TableViewForm $mainForm, &$isValid)
    {
    ...
    {
        if ($this->form instanceof TableViewForm) {
        ...
        if ($class instanceof TableViewForm) {
